...
const board_status_enum_1 = require("../../domain/board-status.enum");
const passport_1 = require("@nestjs/passport");
const get_user_decorator_1 = require("../../../common/decorators/get-user.decorator");
const user_entity_1 = require("../../../auth/user.entity");
const board_status_validation_pipe_1 = require("../../../common/pipe/board-status-validation.pipe");
const create_board_dto_1 = require("../../domain/dto/create-board.dto");
...
BoardsController = __decorate([
    ...
    __param(0, (0, common_1.Inject)(IBoardService_1.IBoardService)),
